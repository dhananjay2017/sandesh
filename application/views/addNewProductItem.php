            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addProductItem" action="<?php echo base_url() ?>addNewItem" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
							 ...
							 <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="hsn_gsn_code"  name="hsn_gsn_code" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="sgst"  name="sgst">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cgst">CGST</label>
                                        <input type="text" class="form-control required" id="cgst" name="cgst">
                                    </div>
                                </div>
                               ...
                               <div class="row">
								<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="igst" name="igst">
                                    </div>
                                </div>
								<div class="col-md-6">
                                    <div class="form-group">
